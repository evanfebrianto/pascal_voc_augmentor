...
DATASET_AUGM_DIR = "./../dataset-augmented"
...
def compute_cluster(image_path):
    ...
    if image_annotation_path:
        ...
        for i in range(0, AUG_NB_AUGMENTATION_PER_IMAGE):
            ...
            aug_config = augmenters.SomeOf(
                ...
                [
                    ...
                    augmenters.Affine(rotate=(-10, 10)),
                    ...
                    augmenters.OneOf([
                        ...
                        augmenters.CoarseDropout(
                            (0.02, 0.05), size_percent=(0.01, 0.02),
                            per_channel=0.2
                        ),
                    ]),
        ...
        print("Removed: {} and {}".format(image_annotation_path, image_path))
